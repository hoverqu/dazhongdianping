...
/**
 * AbstractElmCaterDish entity provides the base persistence definition of the ElmCaterDish entity. @author MyEclipse Persistence Tools
 */

public abstract class AbstractElmCaterDish  implements java.io.Serializable {
    ...
    /** default constructor */
    public AbstractElmCaterDish() {
    }

    
    /** full constructor */
    public AbstractElmCaterDish(String dishUuid, Integer caterid, Timestamp createTime, String dishname, Float price, String picurl, String descr, String unit, Integer dissCount, Integer zanCount, Float dissLevel, String type, Integer salesMonthsum) {
